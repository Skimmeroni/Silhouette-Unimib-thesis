...
\begin{document}
	...
	\chapter{Metodi}
		...
		\section{Sanity check e matrice binaria}
			...
			Lo scatter plot dei due dataset è riportato in Figura~\ref{fig:sc}.
	...
	\chapter{Discussione}
		...
		\section{EHR}
			...
			\begin{figure}[H]
				...
				\caption{Risultati dell'algoritmo DBSCAN per il dataset
				\texttt{HeartFailure.csv}, usando un KNN-plot per stimare $\epsilon$}
			...
			\begin{figure}[H]
				...
				\caption{Risultati dell'algoritmo DBSCAN per il dataset
				\texttt{CardiacArrest.csv}, usando un KNN-plot per stimare $\epsilon$}
			...
			\begin{figure}[H]
				...
				\caption{Risultati dell'algoritmo DBSCAN per il dataset
				\texttt{Neuroblastoma.csv}, usando un KNN-plot per stimare $\epsilon$}
			...
			\begin{figure}[H]
				...
				\caption{Risultati dell'algoritmo DBSCAN per il dataset
				\texttt{Diabetes.csv}, usando un KNN-plot per stimare $\epsilon$}
			...
			\begin{figure}[H]
				...
				\caption{Risultati dell'algoritmo DBSCAN per il dataset
				\texttt{Sepsis.csv}, usando un KNN-plot per stimare $\epsilon$}
