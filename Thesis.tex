...
\begin{document}
	...
	\chapter{Introduzione}
		...
		risultato del clustering, senza che sia necessario farlo manualmente.
		...
		Negli algoritmi di tipo non supervisionato questo é molto piú
		difficile, perché non c'é differenza fra l'insieme di dati
		utilizzato per costruire il modello e l'insieme di dati usato
		per testare il modello: sono lo stesso insieme. Una possibile
		soluzione al problema é data da delle statistiche, il cui valore
		rappresenta l'accuratezza del modello.

		La metrica Silhouette \cite{ROUSSEEUW198753},
